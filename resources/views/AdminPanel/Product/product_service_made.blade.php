                        ...
                        <div class="row mt-3 mt-md-5">
                            <div class="col-md-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label for="product_name" class="col-3 col-form-label"> اسم المتجر <span
                                                    class='text-danger'> * </span> </label>
                                            <div class="col-9">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <select name="store_id" id="" required
                                                            class="form-control form-select  mb-2 @error('store_id') is-invalid @enderror">
                                                            <option value="">@lang('adminPanel.store') </option>
                                                            @foreach ($stores as $store)
                                                                <option value="{{ $store->id }}">{{ $store->getName() }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        @error('store_id')
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label for="product_sub_category" class="col-3 col-form-label"> تصنيف المنتج
                                                الفرعي
                                                <span class='text-danger'> * </span> </label>
                                            <div class="col-9">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="file" class="form-control"
                                                                id="description_image" name="description_image">
                                                        </div>
                                                    </div>
                                                </div>
