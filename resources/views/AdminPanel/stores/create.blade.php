                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    <label for="Name" class="col-2 col-form-label">
                                        @lang('adminPanel.store-name')<span class="text-danger"> * </span>
                                    </label>
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" value="{{ old('store_domain') }}" name="store_domain"
                                            ...
                                            id="Date" placeholder="@lang('adminPanel.domain-name')">
                                        @error('store_domain')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <select name="payment_type_id" id=""
                                            ...
                                            @foreach ($payment_types as $type)
                                                <option value="{{ $type->id }}"
                                                    @if (old('payment_type_id') == $type->id) selected @endif>
                                                    {{ $type->getName() }} </option>
                                            @endforeach
                                        </select>
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                $.each(result.states, function(key,value) {
                    $("#state-dropdown")
                        .append('<option value="'+value.id+'"> @if (app()->getLocale() == 'ar')'+value.city_name_ar+'@endif @if (app()->getLocale() == 'en')'+value.city_name_en+'@endif</option>');
                });
            }
        });
    });
