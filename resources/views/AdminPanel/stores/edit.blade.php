    ...
    <div class="container-fluid">
        <div class="layout-specing">
            <div class="bg-white mt-3">
                ...
                <div class="p-4">
                    <form action="{{ route('admin.stores.update', ['id' => $store->id]) }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            <div class="col-6">
                                                <input type="text" value="{{ $store->store_name_ar }}"
                                                    name="store_name_ar"
                                                    class="form-control @error('store_name_ar') is-invalid @enderror"
                                                    id="NameAr" placeholder=" @lang('adminPanel.name-ar')" disabled>
                                            ...
                                            <div class="col-6">
                                                <input type="text" value="{{ $store->store_name_en }}"
                                                    name="store_name_en"
                                                    class="form-control col-6   @error('store_name_en') is-invalid @enderror"
                                                    id="NameEn" placeholder=" @lang('adminPanel.name-en')" disabled>
                                                @error('store_name_en')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" value="{{ $store->phone_number }}" name="phone_number"
                                            class="form-control   @error('phone_number') is-invalid @enderror "
                                            id="Phone" placeholder=" @lang('adminPanel.mobile-no')">
                                        @error('phone_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <select name="store_admin" id=""
                                            class="form-select form-control  @error('store_admin') is-invalid @enderror" disabled>
                                            @foreach ($admins as $admin)
                                                <option value="{{ $admin->id }}"
                                                    @if ($store->store_admin == $admin->id) selected @endif>{{ $admin->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('store_admin')
                                        ...
                                        <select name="store_country" id="country-dropdown"
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->id }}"
                                                    @if ($store->store_country == $country->id) selected @endif>
                                        ...
                                        <select name="store_city" id="state-dropdown"
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{ $city->id }}"
                                                    @if ($store->store_city == $city->id) selected @endif>
                                                    {{ $city->getName() }} </option>
                                            @endforeach
                                        </select>
                                        @error('store_city')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <input type="date" value="{{ $store->subscription_start_date }}"
                                            name="subscription_start_date"
                                            class="form-control   @error('subscription_start_date') is-invalid @enderror"
                                            id="Phone" placeholder=" @lang('adminPanel.subscription-start-date')">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" value="{{ $store->store_domain }}" name="store_domain"
                                            class="form-control   @error('store_domain') is-invalid @enderror"
                                            id="Date" placeholder="@lang('adminPanel.domain-name')" disabled>
                                        @error('store_domain')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <select name="store_type_id" id="store_type"
                                            class="form-select form-control   @error('store_type') is-invalid @enderror" disabled>
                                    ...
                                    <div class="col-md-3">
                                        <div class="box-backage">
                                            <input type="radio" value="{{ $package->id }}"
                                                @if ($store->subscription_package_id == $package->id) checked @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <select name="payment_type_id" id=""
                                            class="form-select form-control   @error('payment_type_id') is-invalid @enderror">
                                            <option value="">@lang('adminPanel.choose-payment-methods')</option>
                                            @foreach ($payment_types as $type)
                                                <option value="{{ $type->id }}"
                                                    @if ($store->payment_type_id == $type->id) selected @endif>
                                                    {{ $type->getName() }} </option>
                                            @endforeach
                                        </select>
